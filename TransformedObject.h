...
class TransformedObject :
    public Object {
public:
    TransformedObject() : TransformedObject(Vector3D(0.f), Vector3D(0.f), nullptr) {};
    ...
    TransformedObject(const Vector3D rotation, const Vector3D translation, Object* object);
